...
tableData:
  [
   ...
   3. What is meant by a database in SQL?,
   4. Structure of a SQL database table, 
   5. In what ways are SQL databases utilized?, 
   6. Advantages of having SQL database, 
   7. How to create a SQL database?,
   8. How to drop(delete) a SQL database?,
   9. How to take a backup of SQL database?,
   10. Summary,
  ]
---
